...
Compute the conjugate update for a Beta-Binomial model: $P(\theta | y) \propto \text{Beta}(\alpha + y, \beta + n - y)$. Play around with the prior and data to see how posterior changes in real time!
